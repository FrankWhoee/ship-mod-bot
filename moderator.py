...
MODERATED_MESSAGE = "Hey, I deleted one of your messages. If you want to ship something say it with `SHIP:` at the start in a different channel."
ANNOUNCE_MESSAGE = "New Ship: {original}"
